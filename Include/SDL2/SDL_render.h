...
/**
*  \brief Create a texture for a rendering context with shared handle for d3d11 renderer.
*	\this function is present only on WIN32 and Direct3D11 enabled
*
*  \param renderer The renderer.
*  \param w      The width of the texture in pixels.
*  \param h      The height of the texture in pixels.
...
*  \sa SDL_DestroyTexture()
*/
extern DECLSPEC SDL_Texture * SDLCALL SDL_CreateTextureWithSharedHandle_11(SDL_Renderer * renderer,
	int w,
	int h, void* sharedHandle);
#endif
